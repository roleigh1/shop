...
export default function BgImg() {
    return (
        <div class="container my-5">
            <div className="bg-image p-5 text-center shadow-1-strong rounded mb-5 text-white opacity-" style={{backgroundImage: `url('https://i.ibb.co/xJb1qPD/pexels-filipp-romanovski-16205515.jpg')`, objectFit:"cover" }} >
